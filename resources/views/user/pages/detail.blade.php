...
@section('content')
       ...
       <!-- Left Image-->
        <div class="span5">
          <ul class="thumbnails mainimage">
            ...
            <li class="span5">
              <a  rel="position: 'inside' , showTitle: false, adjustX:-4, adjustY:-4" class="thumbnail cloud-zoom" href="{!! asset('resources/upload/detail/'.$img->image) !!}">
                <img  src="{!! asset('resources/upload/detail/'.$img->image) !!}" alt="" title="">
              </a>
            </li>
            @endforeach
          </ul>
  ...
  <section id="related" class="row">
    <div class="container">
      ...
      <ul class="thumbnails">
        @foreach($product_cate as $detail_product_cate)
        <li class="span3">
          <a class="prdocutname" href="{!! url('chi-tiet-san-pham',[$detail_product_cate->id,$detail_product_cate->alias]) !!}">{!! $detail_product_cate->name !!}</a>
          <div class="thumbnail">
            <span class="sale tooltip-test">Sale</span>
            <a href="{!! url('chi-tiet-san-pham',[$detail_product_cate->id,$detail_product_cate->alias]) !!}"><img alt="" src="{!! asset('resources/upload/'.$detail_product_cate->image) !!}"></a>
            <div class="pricetag">
              <span class="spiral"></span><a href="#" class="productcart">ADD TO CART</a>
              <div class="price">
                <div class="pricenew">{!! number_format($detail_product_cate->price,0,',','.') !!}</div>
